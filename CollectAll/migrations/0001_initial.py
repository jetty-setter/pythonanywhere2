    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', models.ManyToManyField(blank=True, related_name='collections', to='CollectAll.category')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favorite_collections', models.ManyToManyField(blank=True, related_name='favored_by', to='CollectAll.collection')),
        ...
        migrations.AddField(
            model_name='collection',
            name='comments',
            field=models.ManyToManyField(blank=True, related_name='collection_comments', to='CollectAll.comment'),
        ),
        migrations.AddField(
            model_name='collection',
            name='parent',
